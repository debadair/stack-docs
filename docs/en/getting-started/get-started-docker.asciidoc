...
so the Docker images are not yet available for this version.
endif::[]
ifeval::["{release-state}"!="unreleased"]
...
https://github.com/elastic/stack-docs/blob/{version}/docs/en/getting-started/docker/[elastic/stack-docs] 
